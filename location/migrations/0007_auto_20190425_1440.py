...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=django.contrib.postgres.fields.ArrayField(base_field=models.UUIDField(), blank=True, help_text='Array of WorkflowLevel2s associated with the SiteProfile.', null=True, size=None),
        ),
    ]
